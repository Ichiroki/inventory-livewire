<div>
    <div class="mb-3 flex justify-between items-center">
        <div>
            <x-button type="button" data-modal-target="create-incoming-modal"
                ...
                <x-modal id="create-incoming-modal" method='save'>
                    ...
                    <x-slot name="content">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <x-button type="button" color="light" data-modal-toggle="create-incoming-modal">
                                Close
                            </x-button>
                        </div>
                    </x-slot>
                                    ...
                                    <x-modal method="delete({{ $incoming->id }})" id="delete-incoming-modal">
                                        ...
                                        <x-slot name="content">
                                            ...
                                            <div class="flex justify-center items-center gap-3 pt-3">
                                                <x-button type="submit" color="danger" data-modal-toggle="delete-incoming-modal">Delete</x-button>
                                                <x-button type="button" color="primary" data-modal-toggle="delete-incoming-modal">No</x-button>
                                            </div>
                                        </x-slot>
                                    </x-modal>
                                </div>
